...
* [Thrift\_learning - AcGit](https://git.acwing.com/fashen/thrift\_learning/-/blob/master/readme.md)
* [AcWing Linux 基础课 | Colopen's blog | Thrift](https://www.colopen-blog.com/Engineer/acw\_linux/)
* [thrift 官网](https://thrift.apache.org/) -> [Tutorial](https://thrift.apache.org/tutorial/) -> [tutorial.thrift](https://git-wip-us.apache.org/repos/asf?p=thrift.git;a=blob\_plain;f=tutorial/tutorial.thrift)
